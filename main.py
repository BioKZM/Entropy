...
extensions = ["cogs.avatar","cogs.settings","cogs.onGuild","cogs.memberCount","cogs.changeColor","cogs.onMemberJoin","cogs.memberCountLoop","cogs.textToSpeech","cogs.level","cogs.levelControl"]
